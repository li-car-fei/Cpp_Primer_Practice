...
(d) unsigned ival=512, jval=1024, kval=4096;        // const unsigned
    unsigned bufsize;
    unsigned swt = get_bufCnt();
    switch(swt) {
        case ival:                              // case 值应当是常量
...
int main(){
    ...
    while(cin >> cur_str){
        ...
        if(cur_duplicate > max_duplicate){
            max_duplicate = cur_duplicate;
            max_duplicate_str = cur_str;
        }
